    ...
    : QWidget(parent)
{
    ...
    m_lsystemEdit->setPlainText(QStringLiteral(
      ...
      "# Grid texture: {Grid, on:{r,g,b}|gray, off:{r,g,b}|gray, freq:8, freqU:8, freqV:8, thickness:0.05}\n"
      "# Stripe texture: {Stripe, freq, thickness:0.05, on:1, off:0}  or  {Stripe{freq:8, ...}}\n"
      "# Noise texture: {Noise, scale, octaves:1, seed:0, min:0, max:1}\n"
